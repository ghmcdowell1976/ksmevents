...
import Header from "../../components/Header";
	...
	const Services = () =>{
        ...
        <div>
            ...
            <p className="text">From full service celebration planning to digital invitations,
             ...
             that will fit your specific needs..</p>
                                        ...
                                        <h3 className="subHeader">Paper Goods</h3>

            <p className="text"><strong>Simple/Flat Invitations</strong> - Includes Design and Printing - $1 each</p>

            <p className="text"><strong>Custom Invitations</strong> - Includes Design, Printing and Assembly- $2-4 each</p>

            <p className="text"><strong>Programs</strong> - Includes Design, Printing and Assembly- $2 each</p>

            <p className="text"><strong>Menus, Thank You cards, Favor labels</strong> - Includes Design, Printing and Assembly- $1 each <br /></p>

                                        <h3 className="subHeader">Party in a Box</h3>

            <p className="text">The “Party in a Box” service is for the do-it-yourselfer that needs just a little help 
            ...
            and 2 other focal decorative pieces.</p>
                      ...
                      <p id="prices"><strong>Small Party - $200                            Large Party - $400</strong></p>
            


                                        <h3 className="subHeader">Special Events</h3>
            <p className="text">We love creating a magical atmosphere for life's celebratory moments! We can help make your
             ...
             people.  Events greater than 50 people begin at $800.<br /></p>

                                        <strong>DAY OF HOSTESS</strong>

            <p className="text">This service allows you to actually participate and enjoy your event while we greet your 
             guests and facilitate any games or other activities you want to occur during the function.  
             Investments for a day of hostess begin at $200.<br /></p>


                                        <h3 className="subHeader">Weddings</h3>

                                  <strong>DAY OF WEDDING COORDINATION</strong>

            <p className="text">Day Of Wedding Coordination is available to put the bride at ease. In this service, we will
            ...
            <p className="text">Our design & decor services are included in our full wedding coordination package but we do 
            ...
            <p className="text">The Full wedding coordination service includes day of wedding coordination, design & decor, 
