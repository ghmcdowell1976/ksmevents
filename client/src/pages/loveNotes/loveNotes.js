	    ...
	    return (
         <div>
            ...
            <Header currentColor={"#D6EAF8"} />
       			...
       			<h1 class="header">Love Notes</h1>

			<p class="text">.......Last but not least, my woman crush, my family,
			...
			<p class="text">Mrs. Kim showed up & showed out! Everything that I 
			...
			<p class="text">Mrs. Kim did a fabulous job at creating something that
